...
def submit_slurm_job(args, command_flags, partition: str = "abc_a100"):
    ...
    cluster_repo = f"/clusterfs/nvme/thayer/platform"
...
def submit_docker_job(args=None, command_flags=None) -> int:
    ...
    container_repo = "/app/platform"  # location of repo in the container
    ...
    docker_vars = (r' -e RUNNING_IN_DOCKER=TRUE'
                   r' -e USER=vscode ')
    docker_image = f"ghcr.io/abcucberkeley/platform:{branch_name}_{CUDA_version}"
