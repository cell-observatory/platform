...
SHAPE=64
MODES=15
DEFAULT='--amp fp16 --opt lamb --lr 5e-4 --wd 5e-5'
CLUSTER='lsf'
...
for NETWORK in 'baseline-base' #'vit-base' 'convnext-base'
do
  for PATCH in 32
  do
...
#bhosts -gpu  h100s | awk '{print $1,$2,$4,$6}' | grep -w "0" | wc -l
#bhosts -gpu h100s | awk '{print $1,$2,$4,$6}' | grep --color=always -w "0"